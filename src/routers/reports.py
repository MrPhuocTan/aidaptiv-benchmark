...
async def page_report_download(
    ...
    """Download benchmark report as PDF (LaTeX-generated)."""
    import logging
    ...
    try:
        ...
        # Get summary stats for comparison bar chart
        summary_stats = {}
        if report_data:
    ...
    # Try to generate PDF via LaTeX
    try:
        from src.reports.pdf_generator import generate_benchmark_pdf, check_latex_available
        ...
        if check_latex_available():
            pdf_bytes = generate_benchmark_pdf(
                ...
                timeline_data=timeline_chart or {},
            ...
            if pdf_bytes:
                ...
                logger.warning(f"PDF generation failed for {run_id}, falling back to HTML")
        else:
            logger.warning("pdflatex not available, falling back to HTML download")
